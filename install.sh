...
for s in game-design/game-design-doc creative/svg-character-design creative/svg-game-ui creative/svg-tileset godot/godot-web-export media/japanese-narration creative/comfy-rtx3060; do
  mkdir -p "$DST/$s"
